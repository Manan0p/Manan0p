...
⚛️ **Next.js** Expert • 🐍 **Python** & **FastAPI** • 🧠 **RAG & Agentic Workflows** • 🔩 **LangChain** • 👁️ **CV**
...
- 🔭 **Currently shipping:** TrackHire — unified job application tracking dashboard with Kanban board, Gmail parsing, Chrome extension & AI resume-JD matching
- 🧠 **Exploring:** Multi-agent systems, LLM Observability, and VectorDB optimization
- 🧱 **Focus:** End-to-end AI system design, event-driven backends, and agentic workflows
- 💬 **Ask me about:** Building with RAG, LangChain SQL agents, Next.js performance, or production ML pipelines
...
<p align="left">
  ...
  <a href="mailto:workfurmanan@gmail.com">
    <img src="https://img.shields.io/badge/EMAIL-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  <a href="https://man-an.me" target="_blank">
...
![Agentic Workflows](https://img.shields.io/badge/Agentic%20Workflows-6D28D9?style=for-the-badge)
...
<p align="center">
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=Manan0p&theme=dark" height="120" width="384" />
  ...
  <img src="https://streak-stats.vercel.app/?user=Manan0p&theme=dark&hide_border=true" height="120" width="304" />
...
| :--- | :--- | :--- |
| [**UniWell**](https://github.com/Manan0p/UniWell) | Full-stack campus healthcare platform with 3 role-based portals, AI triage, and emergency SOS broadcast. | Next.js, Supabase, RBAC |
| [**Splitr**](https://github.com/Manan0p/Splitr) | AI-powered expense splitting app with real-time balance sync and Gemini weekly spending insights. | Next.js 15, Convex, Inngest, Gemini |
| [**JobGuard AI**](https://github.com/Manan0p/JobGuard-AI) | Fake job detection system built on an 18K+ record NLP pipeline, deployed publicly on Hugging Face Spaces. | NLP, Flask, TF-IDF, Hugging Face |
| [**DealDrop**](https://github.com/Manan0p/dealdrop) | Smart product price tracker with intelligent alerts and Generative AI integration. | Next.js, React, Generative AI |
